...
//:
//: You may, of course, want feedback as to when or if `SecRandomCopyBytes` fails. `Entropy.string(bits:secRand)` provides an additional `inout` parameter that acts as  a flag should a `SecRandomCopyBtyes` call fail.
//:
