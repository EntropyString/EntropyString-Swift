...
class EntropyStringTests: XCTestCase {
  ...
  func testBitsFloatFloat() {
    checkEqual(Bits.total(of: 1000,   risk: 1000000), 38.86)
    checkEqual(Bits.total(of: 10000,  risk: 1000000), 45.51)
    checkEqual(Bits.total(of: 100000, risk: 1000000), 52.15)
  }
  
  func testBitsFloatPower() {
    checkEqual(Bits.total(of: 1000,   risk: .ten06), 38.86)
    checkEqual(Bits.total(of: 10000,  risk: .ten06), 45.51)
    checkEqual(Bits.total(of: 100000, risk: .ten06), 52.15)
  }
  
  func testBitsPowerPower() {
    checkEqual(Bits.total(of: .ten03, risk: .ten06), 38.86)
    checkEqual(Bits.total(of: .ten04, risk: .ten06), 45.51)
    checkEqual(Bits.total(of: .ten05, risk: .ten06), 52.15)
  }
...
// MARK: - Helper functions -
  ...
  func checkEqual(_ num1: Float, _ num2: Float) {
    XCTAssertEqual(roundf(num1 * 100)/100, roundf(num2 * 100)/100)
  }
